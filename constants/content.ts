...
export const DEFAULT_DAILY_SCHEDULE = [
  ...
  { day: 3, title: 'Deepening', activities: ['Morning breathwork — deeper practice', 'Surf session — building on foundations', 'Lunch', 'Movement and recovery class', 'Free time for journaling or rest'] },
...
export const DEFAULT_FAQS = [
  ...
  { question: 'What\'s the food like?', answer: 'We serve gourmet, healthy meals made with fresh, local ingredients. Every meal is designed to nourish your body and support your practice. We accommodate all dietary needs — vegetarian, vegan, gluten-free, and any allergies. Just let us know in your guest profile.', category: 'retreats' },
  ...
  { question: 'What\'s the cancellation policy?', answer: 'Full refund for cancellations 60+ days before the retreat start date. 50% refund for 30-60 days. No refund for cancellations less than 30 days before. We understand plans change — reach out if you have special circumstances.', category: 'booking' },
  ...
  { question: 'What if the weather is bad?', answer: 'We plan meticulously, then hold that plan loosely. If conditions aren\'t right for surfing, we adapt — indoor breathwork, movement classes, local excursions, or rest. The ocean teaches us about surrender and flexibility, and that starts with how we design each day.', category: 'retreats' },
